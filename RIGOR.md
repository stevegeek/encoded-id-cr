...
<!-- rigor:summary -->
**This is a fork of encoded_id (https://github.com/stevegeek/encoded_id). The
idea was mine. The plan was an AI's. The implementation was generated by an AI.
I have not examined this code. It ran; that is all I claim. It was tested by an
AI. Changes are now made by an AI unattended. The project is still evolving.
This assessment is as of 2026-09-06. I make no recommendation either way about
depending on it. Why: it is not yet complete. Statement made by: Stephen
Ierodiaconou.**
<!-- /rigor:summary -->
...
forked_from: "encoded_id (https://github.com/stevegeek/encoded_id)"
rigor: unexamined
